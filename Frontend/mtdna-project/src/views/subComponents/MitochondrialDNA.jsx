...
const MitochondrialDNA = () => {
  ...
  return (
    ...
    <HeaderComponent image={bannerImg} text={"Mitochondrial DNA (mtDNA)"} />
      ...
      <div className={`mtdna-container ${darkMode ? "dark-mode" : ""}`}>
      <div className="mtdna-header">
        <h1 className="mtdna-title">Mitochondrial DNA (mtDNA)</h1>
        <div className="mtdna-visual-element"></div>
      </div>
      
      <div className="mtdna-introduction">
        <p>
          Mitochondrial DNA (mtDNA) is a small, circular DNA found in the
